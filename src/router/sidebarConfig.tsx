import type { SidebarConfig, MenuItem } from '../components/CodeSandbox/Code/Sidebar.types'
...
function processRoute(route: SafeRouteConfig, parentPath = ''): MenuItem | null {
...
export function generateSidebarConfig(routes: SafeRouteConfig[]): SidebarConfig {
  const top: MenuItem[] = []
